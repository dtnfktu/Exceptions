...
[Урок 3. Продвинутая работа с исключениями в Java](#lesson03) 
...
[Здесь текст на Java](https://github.com/dtnfktu/Exceptions/blob/main/lesson03/ExceProject.java).  Реализовано в Visual Studio Code.